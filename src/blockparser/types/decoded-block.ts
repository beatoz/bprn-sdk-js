...
export function isDecodedTransaction(
	data: DecodedTransaction | fabprotos.common.IConfigEnvelope | undefined
): data is DecodedTransaction {
	return data !== undefined && data !== null && 'actions' in data;
}

export function isConfigEnvelope(
	data: DecodedTransaction | fabprotos.common.IConfigEnvelope | undefined
): data is fabprotos.common.IConfigEnvelope {
