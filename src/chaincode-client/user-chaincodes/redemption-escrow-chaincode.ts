...
export class RedemptionEscrowChaincode extends Chaincode {
	...
	async approveRedemption(signer: ChaincodeSigner, requestId: string, approvalRef: string = ""): Promise<void> {
		await this.invokeWithSig(signer, "ApproveRedemption", ["", requestId, approvalRef])
	}

	async rejectRedemption(signer: ChaincodeSigner, requestId: string, reason: string = ""): Promise<void> {
	...
	async setRedemptionWallet(signer: ChaincodeSigner, releaseWalletAddress: string): Promise<void> {
	...
	async setStablecoinReleaseWallet(signer: ChaincodeSigner, stablecoinChaincodeName: string, releaseWalletAddress: string): Promise<void> {
	...
	async requestRedemption(
		...
		const requestID = await this.invoke("RequestRedemption", [stablecoinChaincodeName, fromAddress, toAddress, amount, clientRequestID])
